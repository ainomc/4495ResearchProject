...
public class AmenityReservationSystemApplication {
  ...
  public CommandLineRunner loadData(
    ...
    return (args) -> {
      userRepository.save(
          new User("Mikhail Chumakov", "Unit711", bCryptPasswordEncoder().encode("12345")));
        userRepository.save(
                new User("Igor Koshevenko", "Unit900", bCryptPasswordEncoder().encode("12345")));
        userRepository.save(
                new User("Andrey Yatskiv", "Unit1133", bCryptPasswordEncoder().encode("12345")));
